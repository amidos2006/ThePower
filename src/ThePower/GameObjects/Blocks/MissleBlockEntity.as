package ThePower.GameObjects.Blocks 
{
	 ...
	 * @author Amidos
	 */
	public class MissleBlockEntity extends Entity
	{
		[Embed(source = '../../../../assets/Graphics/sprites/blocks/missile_block.png')]private var missleBlock:Class;
		...
		public function MissleBlockEntity(xIn:Number, yIn:Number, layerConstant:Number) 
		{
			x = xIn;
			y = yIn;
			layer = layerConstant;
